/* SortedArray.m created by jolly on Sat 01-Mar-1997 */
...
{
    return [embeddedArray mutableCopy];
}
...
{
    embeddedArray = [[NSMutableArray allocWithZone:[self zone]] initWithCapacity:numItems];
    arrayLock = [[NSRecursiveLock alloc] init];
    comparetype = COMPARE_SELECTOR;
    compareselector =@selector(compare:);
    return self;
