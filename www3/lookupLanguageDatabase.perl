...
dbmopen(%languageTrigramDatabase,'language.trigram.gdbm',0666);
...
if($ARGV[0] eq 'trigrams')
{
	while( ($trigram,$value) = each %languageTrigramDatabase )
	{
		%country=();
		$wordcount=0;
		...
		print $wordcount,%country,"      ",$trigram."\n";
	}
	exit;
}
